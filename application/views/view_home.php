            ...
            <div class="col-md-3 left_col">
				...
				<div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-shopping-cart"></i> Welcome <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="http://localhost/ishop/index/home">Home</a>
                                        </li>
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-male"></i> Search by Category <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
									{categorie}
                                ...
                                <li><a><i class="fa fa-male"></i>Search by Brand <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
									{brand}
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <?php echo "Today is " . date("l ").date(" d-M-Y ");?>
                                    <span class=" fa fa-angle-down"></span>
                                </a>
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    <li><a href="http://localhost/ishop/login/index"><i class="fa fa-sign-out pull-right"></i> Login</a>
                                    </li>
