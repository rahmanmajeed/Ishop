...
$sql = "SELECT (SELECT `product_name` FROM `products` WHERE `product_id` = product_services.product_id) AS name,COUNT(product_id) AS quantity FROM product_services GROUP BY (product_id) DESC LIMIT 5";
