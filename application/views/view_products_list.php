    ...
    <?php include("view_admin_menu.php");?>
		<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="right_col" role="main">
                ...
                <small>
                        <a href="{base_url}product/addProduct">Create New</a>
                    </small>
                        </div>
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
										...
										{products}
                                            <tr>
                                                ...
                                                <td class=" " align="center"> <img style="width: 25%; display: block; height: 10%;" src="{base_url}image/{image_location}" alt="image" /></td>
                                                <td class=" "> {description}</td>
                                                <td class=" last"><a href="{base_url}product/editProduct/{product_id}">Edit</a>
