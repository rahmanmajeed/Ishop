                                    ...
                                    <form class="form-horizontal form-label-left" novalidate method= 'post'>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="cat_name" placeholder="Example: Laptop or Keyboard" required type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="textarea" required name="description" class="form-control col-md-7 col-xs-12"></textarea>
                                            </div>
                                        </div>
