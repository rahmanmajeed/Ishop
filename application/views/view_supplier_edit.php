                                    ...
                                    <form class="form-horizontal form-label-left" novalidate method='post'>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="supplier_name" required type="text" value='{supplier_name}' >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="11" data-validate-words="1" name="supplier_phone"  required="required" type="text" value='{supplier_phone}'>
                                            </div>
                                        </div><div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Email<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="supplier_email"  required="required" type="text" value='{supplier_email}'>
                                            </div>
                                        </div><div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Address<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="supplier_address" required type="text" value='{supplier_address}'>
                                            </div>
                                        </div><div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Deposit<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1" name="security_deposit"  required="required" type="text" value='{security_deposit}'>
                                            </div>
                                        </div>
										<div class="item form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
                                              ...
                                              <input name="buttonUpdate" id="send" type="submit" class="btn btn-success" value="Update">
                                            </div>
                                        </div>
                                    </form>
									{message}
